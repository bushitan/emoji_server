...
class XMLHandler(xml.sax.handler.ContentHandler):
    ...
    def getDict(self):
        return self.mapping
class wx_pay():
    def __init__(self,open_id,wx_out_trade_no,fee):
        #一致的商铺信息
        ...
        NotifUrl = SETTINGS.CALLBACK
        # NotifUrl = "https://xcx.308308.com/huaxun_2/api/pay/callback/wx/"

        # orderId = "123asd" #商铺订单号
        _wx_out_trade_no = wx_out_trade_no#商铺订单号
        device_info = 'WEB'
        body = u'VIP'
        ...
        pmStr += "&openid=" + OpenId
        pmStr += "&out_trade_no=" + _wx_out_trade_no + "&product_id=" + prodId + "&spbill_create_ip=" + ip
        ...
        self.data += "<out_trade_no>" + _wx_out_trade_no + "</out_trade_no>"
